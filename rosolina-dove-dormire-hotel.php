...
<div class="dove-single__intro" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/hotel-bg.jpg')">
	<div class="dove-single__intro-content"><img src="<?php echo get_template_directory_uri(); ?>/assets/i/big-icon.png" alt="icon">
			...
			<div class="dove-single__wrap">
				<div class="dove-single__item" id="js-item-1">
					...
					<div class="dove-single__slider">
						<div class="dove-single__slider-item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/hotel-slides/hotel-slide-1.jpg')"></div>
						<div class="dove-single__slider-item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/hotel-slides/hotel-slide-2.jpg')"></div>
						<div class="dove-single__slider-item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/hotel-slides/hotel-slide-3.jpg')"></div>
						<div class="dove-single__slider-item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/hotel-slides/hotel-slide-4.jpg')"></div>
					</div>
					<div class="dove-single__item-content">
						<header class="dove-single__item-header">
							<ul class="info">
								<li><span class="title">TIPO:</span><span class="value">HOTEL</span></li>
								<li><span class="title">INDIRIZZO:</span><span class="value">VIA TRIESTE 17, ROSOLINA MARE</span></li>
								<li><span class="title">INFO:</span><span class="value">0426/68010 – 0426/326022</span></li>
							</ul>
						</header>
						...
						<div class="dove-single__item-footer">
							<ul class="dove-single__item-contacts">
								<li><a target="_blank" href="http://www.albergofiorella.it/"><span>www.albergofiorella.it</span>
								...
								<li><a class="icon-circle" target="_blank" href="https://www.facebook.com/AlbergoRistoranteFiorella">
										<svg class="facebook">
											<use xlink:href="#facebook"></use>
										</svg></a></li>
								<li><a class="icon-circle" target="_blank" href="https://www.instagram.com/albergo_fiorella_rosolina">
										<svg class="instagram">
				...
				<div class="dove-single__item" id="js-item-2">
					<div class="slider-buttons"><a class="slider-btn slider-btn-prev" href="#"></a><a class="slider-btn slider-btn-next" href="#"></a></div>
					<div class="dove-single__slider">
						<div class="dove-single__slider-item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/hotel-slides/hotel-slide-5.jpg')"></div>
						<div class="dove-single__slider-item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/hotel-slides/hotel-slide-6.jpg')"></div>
						<div class="dove-single__slider-item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/hotel-slides/hotel-slide-7.jpg')"></div>
						<div class="dove-single__slider-item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/hotel-slides/hotel-slide-8.jpg')"></div>
					</div>
					<div class="dove-single__item-content">
						<header class="dove-single__item-header">
							<ul class="info">
								<li><span class="title">TIPO:</span><span class="value">HOTEL</span></li>
								<li><span class="title">INDIRIZZO:</span><span class="value">PIAZZA SAN GIORGIO, 5 ROSOLINA MARE</span></li>
								<li><span class="title">INFO:</span><span class="value">+39 0426 68023</span></li>
							</ul>
						</header>
						<div class="dove-single__item-text">
						...
						<div class="dove-single__item-footer">
							<ul class="dove-single__item-contacts">
								<li><a target="_blank" href="https://www.hotelmilan.it/"><span>www.hotelmilan.it</span>
										<svg class="external-link">
											<use xlink:href="#external-link"></use>
										</svg></a></li>
								...
								<li><a class="icon-circle" target="_blank" href="https://www.facebook.com/hotelmilanrosolina/">
										<svg class="facebook">
											<use xlink:href="#facebook"></use>
										</svg></a></li>
							</ul>
				...
				<div class="dove-single__item" id="js-item-3">
					<div class="slider-buttons"><a class="slider-btn slider-btn-prev" href="#"></a><a class="slider-btn slider-btn-next" href="#"></a></div>
					<div class="dove-single__slider">
						<div class="dove-single__slider-item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/hotel-slides/hotel-slide-9.jpg')"></div>
						<div class="dove-single__slider-item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/hotel-slides/hotel-slide-10.jpg')"></div>
						<div class="dove-single__slider-item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/hotel-slides/hotel-slide-11.jpg')"></div>
						<div class="dove-single__slider-item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/hotel-slides/hotel-slide-12.jpg')"></div>
					</div>
					<div class="dove-single__item-content">
						<header class="dove-single__item-header">
							<ul class="info">
								<li><span class="title">TIPO:</span><span class="value">HOTEL</span></li>
								<li><span class="title">INDIRIZZO:</span><span class="value">PIAZZA S. GIORGIO 15, ROSOLINA MARE</span></li>
								<li><span class="title">INFO:</span><span class="value">3466104429 042668066</span></li>
							</ul>
						</header>
						<div class="dove-single__item-text">
						...
						<div class="dove-single__item-footer">
							<ul class="dove-single__item-contacts">
								<li><a target="_blank" href="www.albergopineta.it"><span>www.albergofiorella.it</span>
										<svg class="external-link">
											<use xlink:href="#external-link"></use>
										</svg></a></li>
								...
								<li><a class="icon-circle" target="_blank" href="https://www.instagram.com/il_gattaccio">
										<svg class="instagram">
											<use xlink:href="#instagram"></use>
										</svg></a></li>
							</ul>

...
<section class="discover-block section section__dark">
	<div class="container">
		...
		<div class="discover-block__content"><a class="discover-block__item" href="https://visitrosolina.it/scopri-rosolina-mare/escursioni/">
				...
				<div class="h3 discover-block__title">Nei dintorni</div><img class="discover-block__icon" src="<?php echo get_template_directory_uri(); ?>/assets/i/discover-icon.svg" alt="icon"><img src="<?php echo get_template_directory_uri(); ?>/assets/i/discover-block-4.jpg" alt="Nei d'intorni"></a></div>
	</div>
</section>
...
<script src="<?php echo get_template_directory_uri(); ?>/assets/libs/jquery.ihavecookies.min.js"></script>

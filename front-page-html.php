...
<div class="where-to-sleep-block">
	<div class="where-to-sleep-block__item"><a class="where-to-sleep-block__wrap" href="https://visitrosolina.it/dove-dormire/hotel/"><img class="where-to-sleep-block__img" src="<?php echo get_template_directory_uri(); ?>/assets/i/where-to-sleep-block/where-to-sleep-block-1.jpg" alt="image">
	...
	<div class="where-to-sleep-block__item"><a class="where-to-sleep-block__wrap" href="https://visitrosolina.it/dove-dormire/villaggi-turistici/"><img class="where-to-sleep-block__img" src="<?php echo get_template_directory_uri(); ?>/assets/i/where-to-sleep-block/where-to-sleep-block-2.jpg" alt="image">
			<div class="where-to-sleep-block__content">
				<h3 class="where-to-sleep-block__subtitle">DOVE DORMIRE</h3>
				<h2 class="where-to-sleep-block__title">Villaggi turistici</h2>
			</div></a></div>
	<div class="where-to-sleep-block__item"><a class="where-to-sleep-block__wrap" href="https://visitrosolina.it/dove-dormire/agenzie-immobiliari/"><img class="where-to-sleep-block__img" src="<?php echo get_template_directory_uri(); ?>/assets/i/where-to-sleep-block/where-to-sleep-block-3.jpg" alt="image">
			<div class="where-to-sleep-block__content">
				<h3 class="where-to-sleep-block__subtitle">DOVE DORMIRE</h3>

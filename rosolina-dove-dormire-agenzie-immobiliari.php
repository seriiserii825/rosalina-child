<?php
/**
 * Template Name: Rosolina Dove Dormire Agenzie Immobiliari
 */
?>
...
<div class="dove-single__intro" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/agenzie-immobiliari/agenzie_immobiliari-bg.jpg')">
	<div class="dove-single__intro-content dove-single__intro-content-full"><img src="<?php echo get_template_directory_uri(); ?>/assets/i/big-icon.png" alt="icon">
			...
			<div class="dove-single__wrap">
				<div class="dove-single__item" id="js-item-1">
					...
					<div class="dove-single__slider">
						<div class="dove-single__slider-item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/vilaggi/agenzie_immobiliari-1.jpg')"></div>
						<div class="dove-single__slider-item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/vilaggi/agenzie_immobiliari-2.jpg')"></div>
						<div class="dove-single__slider-item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/vilaggi/agenzie_immobiliari-3.jpg')"></div>
						<div class="dove-single__slider-item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/vilaggi/agenzie_immobiliari-4.jpg')"></div>
					</div>

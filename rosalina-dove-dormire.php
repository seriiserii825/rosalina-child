...
<header class="main-header"><a class="logo" href="index.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/i/logo.png" alt="logo"></a>
	<div class="main-menu">
...
<section class="intro dove-dormire" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/Home-page.jpg')">
...
<div class="block-about-dove section section__dark">
	<div class="container">
		...
		<p class="section__text">Rosolina Mare offre numerose opportunità per soggiornare:<br> hotel, campeggi e villaggi turistici adatti per le famiglie e per ogni tipo di turista</p>
	</div>
</div>
<div class="block-dove-dormire">
	<div class="block-dove-dormire__item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/dove-dormire/dove-dormire-1.jpg')">
		<div class="block-dove-dormire__wrap"><img class="block-dove-dormire__img" src="<?php echo get_template_directory_uri(); ?>/assets/i/where-to-sleep-block/where-to-sleep-block-1.jpg" alt="image">
			<div class="block-dove-dormire__content">
				...
				<p>Rosolina mare offre molteplici soluzioni di alloggio, gli Hotel sono l’ideale per chi ama il pieno Relax, Strutture riservate e gestite in modo totalmente Familiare permettono ai propri ospiti una vacanza a tutto tondo sempre disponendo della modernità di notevoli comfort.</p><a class="block-dove-dormire__link" href="hotel.html">Scopri tutte le strutture</a>
			</div>
		</div>
	</div>
	<div class="block-dove-dormire__item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/dove-dormire/dove-dormire-2.jpg')">
		<div class="block-dove-dormire__wrap"><img class="block-dove-dormire__img" src="<?php echo get_template_directory_uri(); ?>/assets/i/where-to-sleep-block/where-to-sleep-block-2.jpg" alt="image">
			<div class="block-dove-dormire__content">
				<h3 class="block-dove-dormire__subtitle">DOVE DORMIRE</h3>
				<h2 class="block-dove-dormire__title">Villaggi turistici</h2>
				<p>I Villaggi turistici incarnano lo spirito del vivere all’aria a aperta, attuali strutture dislocate in contesti puramente naturali della località accolgono gli ospiti mettendo a disposizione servizi eccellenti per trascorrere dei momenti unici.</p><a class="block-dove-dormire__link" href="vilagi-turistici.html">Scopri tutte le strutture</a>
			</div>
		</div>
	</div>
	<div class="block-dove-dormire__item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/dove-dormire/dove-dormire-3.jpg')">
		<div class="block-dove-dormire__wrap"><img class="block-dove-dormire__img" src="<?php echo get_template_directory_uri(); ?>/assets/i/where-to-sleep-block/where-to-sleep-block-3.jpg" alt="image">
			<div class="block-dove-dormire__content">
				<h3 class="block-dove-dormire__subtitle">DOVE DORMIRE</h3>
				<h2 class="block-dove-dormire__title">Agenzie immobiliari</h2>
				<p>Per chi desidera una maggiore autonomia, le agenzie immobiliari potranno offrire soluzioni abitative secondo le più disparate preferenze in ogni zona della località.</p><a class="block-dove-dormire__link" href="agenzie-immobiliari.html">Scopri tutte le strutture</a>
			</div>
		</div>
	</div>
</div>
